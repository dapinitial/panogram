...
varied real demo panos. RLS enforced; storage authenticated-write; secret hook + `.githooks` active.
...
1. **Trust & safety** — block / report / basic moderation. **P0 before exposing real users.**
