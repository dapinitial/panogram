...
// Mock feed for the prototype. The card `poster` is a stylized gradient (fast,
// striking); `panoUrl` is a REAL equirectangular image the viewer loads on open.
//
// NOTE: panoUrl currently points at hosted Photo Sphere Viewer demo spheres —
// placeholders until uploads land in Supabase Storage (post.storage_path → public URL).
const SPHERE = "https://photo-sphere-viewer-data.netlify.app/assets/sphere.jpg";
const SPHERE_SM = "https://photo-sphere-viewer-data.netlify.app/assets/sphere-small.jpg";
...
export const POSTS: Post[] = [
  {
    ...
    panoUrl: SPHERE, likes: 1567, comments: 54, saves: 288,
  ...
  },
  {
    ...
    panoUrl: SPHERE_SM, likes: 842, comments: 31, saves: 119,
  },
  {
    ...
    panoUrl: SPHERE, likes: 5540, comments: 231, saves: 980,
  ...
  },
  {
    ...
    panoUrl: SPHERE_SM, likes: 3201, comments: 142, saves: 521,
  },
  {
    ...
    panoUrl: SPHERE_SM, likes: 987, comments: 44, saves: 166,
  },
  {
    ...
    panoUrl: SPHERE, likes: 6120, comments: 301, saves: 1204,
  },
  {
    ...
    panoUrl: SPHERE_SM, likes: 1843, comments: 67, saves: 312,
  },
  {
    ...
    panoUrl: SPHERE_SM, likes: 2890, comments: 98, saves: 445,
  },
];
